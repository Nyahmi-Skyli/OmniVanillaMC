...
public class IronDustItem extends OmnivanillaModElements.ModElement {
	@ObjectHolder("omnivanilla:iron_dust")
	public static final Item block = null;
	public IronDustItem(OmnivanillaModElements instance) {
		super(instance, 5);
	}
